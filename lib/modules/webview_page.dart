...
class WebViewPage extends StatefulWidget {
  ...
  @override
  _WebViewPageState createState() => _WebViewPageState(url: url, title: title);
}
...
class _WebViewPageState extends State<WebViewPage> {
  ...
  _WebViewPageState({required this.url, this.title});
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => launch(url, forceSafariVC: false),
          )
        ],
      ),
